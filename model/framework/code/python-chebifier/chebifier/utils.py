...
def load_chebi_graph(filename=None):
    ...
    if os.path.exists(os.path.join(root, "..", "..", "..", "..", "checkpoints", "chebi_graph.pkl")):
        filename = os.path.join(root, "..", "..", "..", "..", "checkpoints", "chebi_graph.pkl")
    if filename is None:
...
def build_chebi_graph(chebi_version=241):
    ...
    chebi_path = os.path.join(root, "..", "data", f"chebi_v{chebi_version}", "chebi.obo")
    print(chebi_path)
    os.makedirs(os.path.join(root, "..", "data", f"chebi_v{chebi_version}"), exist_ok=True)
...
def get_disjoint_files():
    ...
    local_disjoint_files = [
        os.path.join(root, "..", "data", "disjoint_chebi.csv"),
        os.path.join(root, "..", "data", "disjoint_additional.csv"),
    ]
    disjoint_files = []
